...
@Component({
  selector: 'app-swarg',
  templateUrl: './swarg.component.html',
  styleUrls: ['./swarg.component.css']
})
export class SwargComponent implements OnInit {
  ...
  constructor(private seoService: SeoService) {
    ...
    const title = 'The Last Holy Journey - Package Page - Swarg';
