...
@Component({
  selector: 'app-mukti',
  templateUrl: './mukti.component.html',
  styleUrls: ['./mukti.component.css']
})
export class MuktiComponent implements OnInit {
  ...
  constructor(private seoService: SeoService) {
    ...
    const title = 'The Last Holy Journey - Package Page - Mukti';
