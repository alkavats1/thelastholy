...
@Component({
  selector: 'app-moksh',
  templateUrl: './moksh.component.html',
  styleUrls: ['./moksh.component.css']
})
export class MokshComponent implements OnInit {
  ...
  constructor(private seoService: SeoService) {
    ...
    const title = 'The Last Holy Journey - Package Page - Moksh';
